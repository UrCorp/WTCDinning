...
<head>
  <meta charset="utf-8" />
  <title>[WTC] Mensaje de contacto | {{ $contact['name-momentum'] }}</title>
  <style media="screen">
    th{
      color: #b2b1b1;
    }
  ...
  <div style="width:60%; margin:auto">
    ...
    <div style="margin-top: 4%">
      <table width="60%" style="margin:auto">
        ...
        <tr>
          <td>{{ $contact['name-momentum'] }}</td>
          <td>{{ $contact['phone-momentum'] }}</td>
        </tr>
          ...
          <tr>
            <td>{{ $contact['email-momentum'] }}</td>
            <td>{{ $contact['enterprise-momentum'] }}</td>
          </tr>
      </table>
    </div>
    <hr style="width: 50%; margin-top: 4%">
