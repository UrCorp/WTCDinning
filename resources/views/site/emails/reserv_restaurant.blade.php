...
<head>
  <meta charset="utf-8" />
  <title>[WTC] Reservación | {{ $contact['name'] }}</title>
  <style media="screen">
    .titulos{
      color: #b2b1b1;
      font-weight: 100;
  ...
  <div style="width:80%; margin:auto; max-width:400px">
    ...
    <div style="margin-top:20px">
      <h2 style="text-align: center; color: #79888e">
        ¡Han reservado una mesa en {{ $restaurant->name }}!
      </h2>
    </div>
    <hr class="upshadow">
    <div style="margin-top: 20px">
    ...
    <div >
      <div style="margin:auto">
        ...
        <p style="color:#a8b2b5">1.- Ponerte en contacto a la brevedad <br> 2.- Confirmar la reservación</p>
      </div>
    </div>
